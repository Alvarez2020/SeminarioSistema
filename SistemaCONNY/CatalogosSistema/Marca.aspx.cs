...
namespace SistemaCONNY.CatalogosSistema
{
    public partial class Marca : System.Web.UI.Page
    {
        ...
        NegocioCatMarca metodosNegocio = new NegocioCatMarca();
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            ObjetoMarca objeto = new ObjetoMarca();
            if (txtMarca.Text == "")
            {
            ...
            if (IdMarca.Text == "-1")
            {
                bool resp = metodosNegocio.metodoBusca(txtMarca.Text.Trim());
            ...
            if (IdMarca.Text != "-1")
            {
                objeto.IdMarca = Convert.ToInt32(IdMarca.Text);
            }
            //ojo aca en la base de dato no estaba autonumerico el codigo
            objeto.NombreMarca = txtMarca.Text.ToString().Trim(); ;
        ...
        //protected void gridMarca_RowCommand1(object sender, GridViewCommandEventArgs e)
        //{
        //    GridViewRow row = (GridViewRow)(((Button)e.CommandSource).NamingContainer);
        //    int indice = row.RowIndex;
        //    int Codigo = Convert.ToInt32(gridMarca.DataKeys[indice].Value);

        //    if (e.CommandName == "cmEditar")
        //    {
        //        var BuscarDato = metodosNegocio.metodoSeleccion(Codigo);
        //        txtMarca.Text = BuscarDato.NombreMarca;
        //        IdMarca.Text = BuscarDato.IdMarca.ToString();
