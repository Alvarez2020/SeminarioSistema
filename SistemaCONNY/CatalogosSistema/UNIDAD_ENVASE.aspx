<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UNIDAD_ENVASE.aspx.cs" Inherits="SistemaCONNY.CatalogosSistema.UNIDAD_ENVASE" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h3>Agregar Unidad medida Envase</h3>
                            ...
                            <table id="gridData" class="table table-striped table-bordered" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Descripcion Unidad Envase</th>        
                ...
                <div class="modal-body">
                    ...
                    <div class="panel-body">
                        ...
                        <div hidden class="form-group">
                            <asp:Label Text="ID_UNIDAD_ENVASE" runat="server" />
                            <asp:TextBox ID="IdUnidadEnvase" runat="server" class="form-control" type="text" Text="0" placeholder="ID_UNIDAD_ENVASE"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:Label Text="DESCRIPCION_UNIDAD_ENVASE" runat="server" />
                            <asp:TextBox ID="txtDescripcionUnidadEnvase" runat="server" CssClass="form-control" type="text" placeholder="DESCRIPCION_UNIDAD_ENVASE"></asp:TextBox>
                            <asp:RequiredFieldValidator ForeColor="red" ValidationGroup="valGuardar" ControlToValidate="txtDescripcionUnidadEnvase" ID="RequiredFieldValidator1" runat="server" ErrorMessage="Campo es necesario" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderScript" runat="server">
    <script>    
         ...
         function LoadTemp() {
             ...
             $.ajax({
                 type: "POST",
                 url: "<%= ResolveUrl("UNIDAD_ENVASE.aspx/CargarDatos") %>",
            ...
            //funcion que permite seleccionar datos de la tabla
             $('#gridData').on('click', '#btnEditar', function () {
                ...
                // console.log(globalDataEdicion);
                 var id = globalDataEdicion.IdUnidadEnvase;
                // console.log(id);
                 $('#<%=IdUnidadEnvase.ClientID%>').val(id);
                 $('#<%=txtDescripcionUnidadEnvase.ClientID%>').val(globalDataEdicion.DescripcionEnvaseUnidad);
             ...
             $('#gridData').on('click', '#btnEliminar', function (e) {
                 ...
                 var id = data_form.IdUnidadEnvase;
                 var isConfirm;
                 //this.preventDefault();
                 e.preventDefault();
                 swal({
                     ...
                     function (isConfirm) {
                         if (isConfirm) {
                             $.ajax({
                                 type: "POST",
                                 data: '{codigo:' + id + '}',
                                 url: "<%= ResolveUrl("UNIDAD_ENVASE.aspx/suprData") %>",
                                   contentType: "application/json; charset=utf-8",
                                   dataType: "json",
                                   success: function (response) {
                                       LoadTemp();
                                       $('#<%=IdUnidadEnvase.ClientID%>').val('0');
                                       $('#<%=txtDescripcionUnidadEnvase.ClientID%>').val('');
